...
const EtsTime = () => {
  ...
  const notPastEts = sortedUsers.filter((user) => {
    return user.ets.seconds > dayjs().unix();
  });

  const passedEts = sortedUsers.filter((user) => {
    return user.ets.seconds < dayjs().unix();
  });
  ...
  return (
    <>
      ...
      <div className="ets-table-container">
        <div className="past-ets-table-title">Past ETS</div>
        <table className="ets-table">
          <tbody className="ets-table-body">
            <tr className="ets-table-record">
              <th>Name</th>
